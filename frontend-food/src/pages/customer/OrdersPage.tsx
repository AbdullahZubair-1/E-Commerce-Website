              ...
              >
                <div className="flex items-start gap-4">
                  <div className="h-10 w-10 rounded-full bg-orange-50 flex items-center justify-center flex-shrink-0">
                    <ShoppingBagIcon className="h-5 w-5 text-orange-600" aria-hidden="true" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <ChevronRightIcon className="h-5 w-5 text-gray-400 group-hover:text-orange-600 transition-colors" aria-hidden="true" />
                </div>
              </Link>
            ))}
          </div>
