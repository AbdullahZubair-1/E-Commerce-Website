      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 no-underline">
            <BeakerIcon className="h-12 w-12 text-orange-400" aria-hidden="true" />
          </Link>
          <h1 className="text-2xl font-bold text-white mt-4">Admin Login</h1>
          <p className="text-gray-400 text-sm mt-1">Chemisto Food — Owner Portal</p>
        </div>

        <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700">
          <div className="flex items-center justify-center mb-6">
            <div className="h-14 w-14 rounded-full bg-orange-600/20 border border-orange-500/30 flex items-center justify-center">
              <LockClosedIcon className="h-6 w-6 text-orange-400" aria-hidden="true" />
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
            <div>
              ...
              <input
                ...
                type="email"
                autoComplete="email"
                className="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2.5 text-white text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                {...register('email')}
