  ...
  const widget = (
    <div className="fixed bottom-4 right-4 z-[9999] flex flex-col items-end pointer-events-auto">
      {open && (
        <div className="w-[340px] max-w-full bg-white border border-slate-200 shadow-xl rounded-3xl overflow-hidden mb-3">
          <div className="bg-slate-900 text-white px-4 py-3 flex items-center justify-between gap-4">
            <div>
              <p className="text-sm font-semibold">Ana · Chemisto Food Assistant</p>
            ...
            {callState === 'idle' ? (
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-2xl border border-slate-300 px-4 py-3 text-sm outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-100"
                />
                <button
                  type="button"
                  onClick={sendMessage}
                  disabled={loading}
                  className="inline-flex items-center justify-center rounded-2xl bg-orange-600 px-4 py-3 text-white text-sm font-medium hover:bg-orange-700 disabled:cursor-not-allowed disabled:bg-slate-300"
                >
      ...
      <button
        ...
        className="inline-flex items-center gap-2 rounded-full bg-orange-600 px-4 py-3 text-white shadow-lg shadow-orange-500/20 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-200"
      >
